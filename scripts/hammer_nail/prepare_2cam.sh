...
SOURCE_ROOT="${SOURCE_ROOT:-data/dexjoco/dexjoco_lerobot_datasets/hammer_nail}"
OUTPUT_ROOT="${OUTPUT_ROOT:-data/hammer_nail_fastwam}"
TASK=hammer_nail_uncond_2cam_384_1e-4
...
with initialize_config_dir(version_base="1.3", config_dir=config_dir):
    cfg = compose(config_name="train", overrides=["task=hammer_nail_uncond_2cam_384_1e-4"])
...
echo "[prepare_2cam] done. Run: bash scripts/hammer_nail/train_2cam.sh"
