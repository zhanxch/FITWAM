...
SOURCE_ROOT="${SOURCE_ROOT:-data/dexjoco/dexjoco_lerobot_datasets/pinch_tongs}"
OUTPUT_ROOT="${OUTPUT_ROOT:-data/pinch_tongs_fastwam}"
TASK=pinch_tongs_uncond_2cam_384_1e-4
...
with initialize_config_dir(version_base="1.3", config_dir=config_dir):
    cfg = compose(config_name="train", overrides=["task=pinch_tongs_uncond_2cam_384_1e-4"])
...
echo "[prepare_2cam] done. Run: bash scripts/pinch_tongs/train_2cam.sh"
