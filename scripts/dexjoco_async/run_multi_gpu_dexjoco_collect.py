...
def parse_args() -> argparse.Namespace:
    ...
    model.add_argument("--dataset-stats-path", type=str, default=None)
    ...
    model.add_argument("--api-token", type=str, default=None)
    ...
    outputs.add_argument("--overwrite", action=argparse.BooleanOptionalAction, default=True)
    ...
    try:
        ...
        for shard in shards:
            ...
            cmd = build_conda_command(
                ...
                exports,
                _build_collect_argv(args, shard, shard_dataset_dir),
                raw_exports=raw_exports,
            )
            proc = launch_subprocess(cmd, log_path=log_path, cwd=PROJECT_ROOT)
