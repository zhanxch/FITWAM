...
export INIT_WEIGHTS="${INIT_WEIGHTS:-${ROOT_DIR}/checkpoints/dexjoco/fold_glasses_fastwam/weights/step_010000.pt}"
export SOURCE_CHECKPOINT="${SOURCE_CHECKPOINT:-${INIT_WEIGHTS}}"
export TMUX_SESSION="${TMUX_SESSION:-fold_dewo_v2_full_1e-4_s0}"
export DEWO_TASK="${DEWO_TASK:-dexjoco/dexjoco_fold_glasses_offline_b1_jump_fast_full_1e-4_s0}"
