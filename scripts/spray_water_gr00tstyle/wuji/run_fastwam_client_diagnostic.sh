...
#
# Usage:
#   scripts/spray_water_gr00tstyle/wuji/run_fastwam_client_diagnostic.sh \
...
#   python scripts/spray_water_gr00tstyle/wuji/run_fastwam_server.py \
...
WRAPPER="${REPO_ROOT}/scripts/spray_water_gr00tstyle/wuji/run_fastwam_client_with_env.sh"
